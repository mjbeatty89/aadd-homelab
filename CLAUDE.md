...
| DIF checker | Recursive multimodal diff checker (Claude orch project) |
...
| Claude Orchestration | OpenClaw downstream models + multimodal diff checker |
...
- Interested in Claude orchestration / multi-agent systems
- Cowork mode preferred over OpenClaw for Claude agent work
